import { User, Phone, MapPin, Globe, Settings, Star } from "lucide-react";
  ...
  return (
    <div className="profile-container">
      <div className="profile-wrapper">
        ...
        {/* Edit Button */}
        <div className="flex justify-end mb-8 animate-slide-up-delay-1">
        ...
        <div className="profile-grid">
          ...
          <div className="animate-slide-up-delay-4">
            <ProfileSection title="Languages Known" icon={Globe}>
          ...
          {/* Account Information */}
          <div className="animate-slide-up-delay-4">
            <ProfileSection title="Account Details" icon={Settings}>
              <div className="profile-fields-grid">
                ...
                <ProfileField label="Account Status" value={profileData.is_verified ? "Verified ✓" : "Pending"} />
              </div>
            </ProfileSection>
          </div>
        </div>
